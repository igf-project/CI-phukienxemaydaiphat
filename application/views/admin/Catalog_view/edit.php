                ...
                <div class="tab-pane fade active in" id="info">
                    <div class="row">
                        <div class='form-group col-md-6'>
                            <label>Tên</label><font color="red">*</font><small>(Tên để tạo đường link)</small>
                            <input name="txt_name" type="text" id="txt_name" value="<?php echo $result['name']?>" class='form-control' placeholder='Tên nhóm tin' required />
                        </div>
                        <div class='form-group col-md-6'>
                            <label>Bí danh</label>
                            <font color="red">*</font> 
                            <small>(Tên hiển thị ra bên ngoài website)</small>
                            <input name="txt_alias" type="text" id="txt_alias" value="<?= $result['alias']?>" class='form-control' placeholder="Tên đại diện (bí danh)" required />
                        </div>
