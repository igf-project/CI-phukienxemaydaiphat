					...
					<div class="row">
						<div class="col-md-9 col-md-offset-3">
							<ul class="breadcrumb">
								...
								<?php
								if(isset($parent_cata)){
									foreach ($parent_cata as $k => $v) {
										echo '<li><a href="'.base_url().$v['code'].'" title="'.$v['alias'].'">'.$v['alias'].'</a></li>';
									}
								}
								?>
								<li><a href="<?php echo base_url().$result['code'] ?>" title="<?= $result['alias'] ?>"><?= $result['alias'] ?></a></li>
							</ul>
						</div>
					</div>
				</div>
		...
		<div class="row">
			<div class="blog-product col-md-9">
				<div class="sub-menu-list">
					<?php
					foreach ($child_cata as $k => $v) {
						echo '<a href="'.base_url().$v["code"].'" title="'.$v["alias"].'">'.$v["alias"].'</a>';
					}
					?>
				</div>
